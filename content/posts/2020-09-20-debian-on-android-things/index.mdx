...
date: 2020-09-20
excerpt: 安装 Debian 或者 Ubuntu 在性能不太好的 Android Things imx7d，基于 5.10 的内核，或者更新的版本的内核
---
...
![jumper usb boot](./images/pico-imx6-pi-serial-download-mode.png)
...
![jumper emmc boot](./images/pico-imx6-pi-emmc.png)
