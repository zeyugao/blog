...
author: Elsa Granger
hero: ./images/openvpn-hero.jpeg
excerpt: 将 OpenVPN 代理转换成 Shadowsocks 代理，使得能够在终端设备上实现分流
date: 2021-03-27
---
...
![vless -> socks -> openvpn, pi](./images/vless-socks-openvpn-pi.jpg)

socks -> openvpn

![socks -> openvpn, pi](./images/socks-openvpn-pi.jpg)
...
![shadowsocks -> socks -> openvpn, i5-4590](./images/shadowsocks-socks-openvpn-x86.jpg)
